...
Tracking::Tracking(System *pSys, ORBVocabulary* pVoc, FrameDrawer *pFrameDrawer, MapDrawer *pMapDrawer, Map *pMap, KeyFrameDatabase* pKFDB, const string &strSettingPath, const int sensor, shared_ptr<PointCloudMapping> pPointCloud, bool bReuseMap):
...
void Tracking::CreateNewKeyFrame()
{
    ...
    mpPointCloudMapping->insertKeyFrame( pKF, this->mImRGB, this->mImDepth );//PCL
